...
<option value="ceria">Ceria</option>
        ...
        <td width="115" align="center"><select name="rego" onchange="cekharga()">
<script>regionState.printOptions("STATE1")</script>
      ...
      <tr> 
        <th scope="row">No HP Tujuan</th>
        <th scope="row">&nbsp;</th>
        <th colspan="2" scope="row"><input name="tujuan" type="text" id="tujuan" /></th>
      </tr>
      <tr> 
        <th colspan="2" scope="row">&nbsp;</th>
        <th colspan="2" scope="row"> <input type="hidden" name="akun" value="<?=rand(100,999)?>" /></th>
      </tr>
      <tr> 
        <th colspan="4" scope="row"><input type="hidden" name="lr_acc" value="U3068418" /> 
